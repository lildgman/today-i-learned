...
public class QuerydslBasicTest {
    ...
    public void search() {
        Member findMember = queryFactory
                .selectFrom(member)
                .where(member.name.eq("member1").and(member.age.eq(20)))
                .fetchOne();
...
//                .fetchFirst();
    ...
    public void subQueryGoe() {
        ...
        assertThat(result).extracting("age").containsExactly(40,50);
    }
    ...
    public void subQueryIn() {
        ...
        assertThat(result).extracting("age").containsExactly(20,30,40,50);
    }
    ...
    public void findDtoByJPQL() {
        List<MemberDto> resultList = em.createQuery("select new study.querydsl.dto.MemberDto(m.name, m.age) from Member m", MemberDto.class).getResultList();
